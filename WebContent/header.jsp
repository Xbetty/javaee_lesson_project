	...
	<div class="menu" id="menu-box">
		...
		<div class="search">
			<input type="text" name="search_text" id="search_text"
				placeholder="输入搜索内容" />
			<button class="icon-search" id="search" onclick="searchNews()"></button>
			<script type="text/javascript">
				function searchNews() {
					...
					if ($("#search_text").val() == "") {
						...
						window.location.href = "findInfosByPage.action?keywords="
								+ searchText;
						/* var url = "findInfosByPage.action?keywords="
								+ searchText;
						$.post(url, searchText, function(data) {
							alert(data);
							$("#index_div").load("searchResult.jsp");
						}, "json");
						 */
					} 
				}
		...
		<div id="demo" style='display: none;'>${category.cname }</div>
		<ul id="navigator">
			<li><a id="sy" href="index.jsp" class="active">首页</a></li>
			<script type="text/javascript">
				$(function() {
												...
												.each(
														function(i, n) { //i:数组中当前对象的索引   n:数组中当前对象
															...
															if ($("#demo")
																...
																$("#navigator")
																		.append(
																				"<li><a class='active' href=${pageContext.request.contextPath}/findInfosByCid.action?cid="
																						+ t
																						+ ">"
																						+ n.cname
																						+ "</a></li>");
