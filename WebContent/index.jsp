		...
		<div class="slide-container">
			<section id="dg-container" class="dg-container">
				<div class="dg-wrapper">
					<a href="${pageContext.request.contextPath}/findInfosByCid.action?cid=11"><img src="./img/slide1.jpg" alt="image01"></a> <a
						href="${pageContext.request.contextPath}/findInfosByCid.action?cid=9"><img src="./img/slide2.jpg" alt="image02"></a> <a
						href="${pageContext.request.contextPath}/findInfosByCid.action?cid=9"><img src="./img/slide3.jpg" alt="image03"></a>
				</div>
				<nav>
		...
		<div class="container">
			...
			<div class="item col-12">
				<div class="item-header">
					<div class="item-header-r">
						<a
							href="${pageContext.request.contextPath}/findInfosByCid.action?cid=1"
			...
			<div class="item col-6 col-r">
				<div class="item-header">
					<div class="item-header-r">
						<a
							href="${pageContext.request.contextPath}/findInfosByCid.action?cid=13"
							class="icon-more" title="更多"></a>
					</div>
					<div class="item-header-l">
				...
				<div class="item-body item-img-list">
					<div class="item-img">
						...
						<!-- s标签 iterator是迭代 ，用之前导入标签库-->
						<s:iterator value="#request.xsjlInfos" var="xsjlInfo"
							id="xsjlInfo" status="status">
							<s:if
			...
			<div class="item col-6 col-l">
				<div class="item-header">
					<div class="item-header-r">
						<a
							href="${pageContext.request.contextPath}/findInfosByCid.action?cid=3"
							class="icon-more" title="更多"></a>
					</div>
					<div class="item-header-l">
			...
			<div class="item col-4 col-r">
				<div class="item-header">
					<div class="item-header-r">
						<a
							href="${pageContext.request.contextPath}/findInfosByCid.action?cid=4"
							class="icon-more" title="更多"></a>
					</div>
					<div class="item-header-l">
			...
			<div class="item col-4 col-rl">
				<div class="item-header">
					<div class="item-header-r">
						<a
							href="${pageContext.request.contextPath}/findInfosByCid.action?cid=12"
							class="icon-more" title="更多"></a>
					</div>
					<div class="item-header-l">
			...
			<div class="item col-4 col-l">
				<div class="item-header">
					<div class="item-header-r">
						<a
							href="${pageContext.request.contextPath}/findInfosByCid.action?cid=6"
							class="icon-more" title="更多"></a>
					</div>
					<div class="item-header-l">
