...
public class CategoryAction extends ActionSupport implements ModelDriven<Category> {
	...
	// 后台查询信息类别数据
	@Action(value = "/admin/findAllCategory", results = {
			@Result(name = "success", location = "/admin/category/list.jsp") })
	...
	public String findAllCategoryForDrop() {
		try {
			...
			/*
			 * String json = "["; for (int i = 0; i < list.size(); i++) {
			 * Category c = list.get(i); if(i>0){ json+=","; } json
			 * +="{\"cid\":'"+c.getCid()+"','cname':'"+c.getCname()+"'}"; }
			 * json+="]";
			 */
	...
	// 添加分类
	@Action(value = "/admin/addCategory", results = {
			@Result(name = "success", location = "/admin/findAllCategory", type = "redirect") })
	...
	// 删除某个分类
	@Action(value = "/admin/delCategory", results = {
			@Result(name = "success", location = "/admin/findAllCategory", type = "redirect") })
	...
	// 根据cid查询指定类别对象
	@Action(value = "/admin/editCategory", results = {
			@Result(name = "success", location = "/admin/category/edit.jsp") })
	...
	// 更新类别
	@Action(value = "/admin/updateCategory", results = {
			@Result(name = "success", location = "/admin/findAllCategory", type = "redirect") })
